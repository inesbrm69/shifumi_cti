Shifumi.CIT est le projet développé par Célia, Inès et Tom.
...
Pour lancer le jeu, il faut dans un premier temps configurer le serveur (port 50000) et créer les "clients".
